...
use Dwo\FlaggingManager\Cache\CacheOrDelegateFeatureManager;

class CacheOrDelegateFeatureManagerTest extends \PHPUnit_Framework_TestCase
{
    public function testCacheSave()
    {
        ...
        $manager = new CacheOrDelegateFeatureManager($cache, $delegatedManager);
